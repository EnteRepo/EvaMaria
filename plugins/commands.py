...
# ---------- End -------------#
SB = [[
            InlineKeyboardButton('➕ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ➕', url=f'http://t.me/uptoUtubebot?startgroup=true')
            ],[
...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            ...
            #],
           # [
                InlineKeyboardButton('ℹ️ Help', url=f"https://t.me/uptoUtubebot?start=help"),
            ]
            ]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "Jᴏɪɴ Mʏ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ", url=invite_link.invite_link
                )
            ]
        ]
